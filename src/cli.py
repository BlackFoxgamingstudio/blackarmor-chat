#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-blackarmor-chat
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Secure, self-hosted web collaboration and chat interface with CI/CD deployment automation. Features document collaboration integration, real-time message broadcasting, and encrypted database persistence.")
