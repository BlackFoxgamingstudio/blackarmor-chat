# Changelog — Sovereign BlackArmor Chat
...
### Added
- Initial production release of Sovereign BlackArmor Chat (PKG-024)
- Core microservice on port `8804`
- n8n webhook adapter (`n8n/webhook_adapter.py`)
- REST API (`POST /api/v1/execute`, `GET /health`)
- Components: WebSocketServer, MessageBroker, PresenceEngine, EncryptionLayer, ThreadManager
- pyproject.toml packaging with `[dev]` extras
- CLI: `sovereign-blackarmor-chat --help`
...
[Unreleased]: https://github.com/BlackFoxgamingstudio/blackarmor-chat/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/BlackFoxgamingstudio/blackarmor-chat/releases/tag/v1.0.0
